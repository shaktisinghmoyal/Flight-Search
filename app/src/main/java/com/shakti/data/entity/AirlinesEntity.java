...
public class AirlinesEntity {
     ...
     * @param sG
     */
    public AirlinesEntity(String sG, String aI, String g8, String _9W, String _6E) {
        super();
        this.sG = sG;
        this.aI = aI;
        this.g8 = g8;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AirlinesEntity) == false) {
            return false;
        }
        AirlinesEntity rhs = ((AirlinesEntity) other);
